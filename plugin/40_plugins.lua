...
-- They significantly improve user experience in a way not yet possible with
-- MINI.
...
-- have full support of its highlight groups.
-- Use if you don't like `miniwinter` enabled in `plugin/30_mini.lua` or other
-- suggested `mini.hues` based ones.
-- Config.now(function()
