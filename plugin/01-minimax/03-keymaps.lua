...
-- General mappings
-- ─────────────────────────────────────────────────────────────────────────────
-- Use this section to add custom general mappings.
...
-- Leader mappings
-- ─────────────────────────────────────────────────────────────────────────────
-- Neovim has the concept of a Leader key (see `:h <Leader>`).
-- It is a configurable key that is primarily used for "workflow" mappings
-- (opposed to text editing).
...
-- Both keys are usually chosen to create some kind of mnemonic.
-- Example:
-- `<Leader>f`  - groups "find" type of actions.
...
-- denotes global and uppercase second key denotes local.
-- Example:
-- `<Leader>fs` / `<Leader>fS` - find workspace/document LSP symbols.
--
...
-- an attempt to be more concise yet descriptive.
-- See `:h <Cmd>`.
...
--
-- All these use `mini.pick`.
-- See `:h MiniPick-overview` for an overview.
...
-- LSP mappings (like `:h gra` and others).
-- This is needed because `gr` is mapped by an "replace" operator in
-- `mini.operators` (which is more commonly used).
