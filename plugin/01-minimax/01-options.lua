...
-- See `:h '<opt>'` (replace `'<opt>'` with actual option name).
--
...
-- This reads as
-- "Start of list item is:
-- at least one special character (digit, `-`, `+`, `*`),
-- possibly followed by punctuation (`.` or `)`),
...
-- This configures a more conservative display while still being useful.
